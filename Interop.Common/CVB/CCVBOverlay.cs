...
namespace Interop.Common.CVB
{
    public sealed class CCVBOverlay
    {
        ...
        public static void SmartRectangleDraw(AxCVDISPLAYLib.AxCVdisplay _dp, int _id, Cvb.Image.TArea _Area, Color _colorFG, Color _colorHL, bool _Drag)
        {
            ...
            _dp.AddOverlayObjectNET("SmartRectangle", String.Format("SmartRectangle #{0:0} overlay", _id), _Drag, false, Cvb.Plugin.ColorToInt32(_colorFG), Cvb.Plugin.ColorToInt32(_colorHL), false, _id, pixels.ToInt32(), data.ToIntPtr());
